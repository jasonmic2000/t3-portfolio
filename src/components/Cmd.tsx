  ...
  return (
    <KBarResults
      ...
      onRender={({ item, active }) =>
        typeof item === "string" ? (
          <div className="h-full w-full cursor-pointer p-3 text-xs uppercase text-gray-700 dark:text-zinc-500">
            {item}
          </div>
        ) : (
          <ResultItem
...
const ResultItem = React.forwardRef(
  (
    ...
    return (
      <div
        ref={ref}
        className={`align-center flex cursor-pointer justify-between py-2 px-3 transition-all ${
          active
